...
function Index() {
    ...
    let automobileCategory = categoryContext.category ? categoryContext.category.filter((cat) => cat.name === 'Automobile') : [];
    let realEstateCategory = categoryContext.category ? categoryContext.category.filter((cat) => cat.name === 'Real Estate') : [];
    return (
        <>
            {/* Home slider */}
            {loader && <div className="cash-loader">
            ...
            <div className="">
                <section className="p-0 position-relative ">
                    <div className="slide-1 home-slider position-relative">
                        <div>
                            <div className="home  text-center">
                                <div className="overlay position-absolute top-0 left-0 bottom-0 right-0 w-100 h-100 " style={{ background: '#00000005' }}></div>
                                <img ref={imgRef} src={require('../../assets/images/cashiet/cashiet-homepage.jpg')} alt="" className="bg-img blur-up lazyload" />
                                <div className="container">
                                    <div className="row">
                                        <div className="col">
                                            <div className="slider-contain">
                                                <div>
                                                    <h4>Welcome to Cashiet</h4>
                                                    <h1>Buy now, pay later</h1>
                                                    <a href="/products" className="btn btn-solid">shop now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="container">
                    <div className="row partition2">
                        <div className="col-md-6" style={{ marginTop: '40px' }}>
                            <a href={`/products/filter?category=${automobileCategory[0]?._id}`}>
                                <div className="collection-banner p-right text-center">
                                    <div className="img-part position-relative">
                                        <div className="overlay position-absolute top-0 left-0 bottom-0 right-0 w-100 h-100 " style={{ background: '#00000005' }} ></div>
                                        <img src={require('../../assets/images/cashiet/cashiet-ride-now.jpg')} alt="" className="img-fluid blur-up lazyload bg-img" />
                                    </div>
                        ...
                        <div className="col-md-6" style={{ marginTop: '40px' }}>
                            <a href={`/products/filter?category=${realEstateCategory[0]?._id}`}>
                                <div className="collection-banner p-right text-center">
                                    <div className="img-part position-relative">
                                        <div className="overlay position-absolute top-0 left-0 bottom-0 right-0 w-100 h-100 " style={{ background: '#00000005' }} ></div>
                                        <img src={require('../../assets/images/cashiet/cashiet-home.jpg')} alt="" className="img-fluid blur-up lazyload bg-img" />
                                    </div>
                                    <div className="contain-banner">
                                        <div>
                                            <h4>Home Now,</h4>
                ...
                <div className="row">
                    <div className="col-lg-6 offset-lg-3">
                        <div className="product-para">
                            <p className="text-center">Cars, Lands and Property; Home and Office Appliances; Phones and
            ...
            {/* Parallax banner */}
            <section className="p-0 position-relative">
                <div className="overlay position-absolute top-0 left-0 bottom-0 right-0 w-100 h-100 " style={{ background: '#00000005', zIndex: '1' }} ></div>
                <div className="full-banner parallax text-center p-left">
                    <img src={require('../../assets/images/cashiet/cashiet-buy-now.jpg')} alt="" className="bg-img blur-up lazyload" />
                    <div className="container">
                        <div className="row">
                            <div className="col">
                        ...
                        <div className="col-md-4 service-block">
                            <div className="media">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1"
                                    id="Capa_1" x="0px" y="0px" viewBox="0 0 480 480" style={{ enableBackground: 'new 0 0 480 480' }}
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12">
                            <OwlCarousel className="owl-theme" id="owl_wrap" loop margin={50} items={6} autoplay={true} {...options} nav>
                                <div className="item">
                                    <div className="logo-block logo_blck">
