...
const TopSelling = () => {
  ...
  const getProducts = async (limit) => {
    ...
    try {
      const response = await httpService.get('/products/top-selling-products?limit=' + limit);
  ...
  return (
    <>
      <div className="title1 section-t-space">
        ...
        <h2 className="title-inner1">Top selling gadget</h2>
      </div>
      <section className="section-b-space pt-0 ratio_asos">
        ...
        {/* Quick-view-2 modal popup start*/}
        <div
