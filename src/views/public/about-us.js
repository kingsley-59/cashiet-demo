...
const AboutUs = () => {
    return (
        <>
            {/* breadcrumb start */}
            <Breadcrumb title="About Us" breadcrumbItem="About Us" />
            {/* breadcrumb End */}
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            {/* <div className="banner-section" style={{maxHeight: '600px'}}><img src="assets/images/about-us-1.jpg" className="img-fluid blur-up lazyload" alt="" /></div> */}
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-sm-12 col-md-6 col-lg-3">
                            <h4>About Us</h4>
                            <p>
                                We are a financial company with the goal to provide installment payment services for goods
                                and services, thereby making it affordable for the buyers.
                            </p>
                        </div>
                        <div className="col-sm-12 col-md-6 col-lg-3">
                            <h4>Why choose Us</h4>
                            <p>
                                Quality Product <br />
                                We provide an unbeatable payment plan for goods and services. <br />
                                24/7 Support: Both intending and existing customer have access to 24/7 customer care support. <br />
                            </p>
                        </div>
                        <div className="col-sm-12 col-md-6 col-lg-3">
                            <h4>Mission</h4>
                            <p>
                                To help people, employees, investors and residents to achieve ‘the better life’.
                                Creating and establishing an easy and profitable way for buying and selling.
                        ...
                        <div className="col-sm-12 col-md-6 col-lg-3">
                            <h4>Vision</h4>
                            <p>
                                Our Vision at CASHIET is to create an affordable means of buying and selling
                                so as to deliver innovative, value added goods and services to customers.
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="col-sm-12">
                                <div className="slide-2 testimonial-slider no-arrow">
                                    ...
                                    <div>
                                        <div className="media">
                                            <div className="text-center">
                                                <img src="assets/images/female-avatar.jpg" alt="#" />
                                                <h5>Mark Jecno</h5>
                                                <h6>Designer</h6>
                                            </div>
                                            <div className="media-body">
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                ...
                                <div className="team-4">
                                    <div>
                                        <div>
                                            <img src="assets/images/team_1.jpg" className="img-fluid blur-up lazyload" alt="" />
                                        </div>
                                        <h4>Hileri Keol</h4>
                                    ...
                                    <div>
                                        <div>
                                            <img src="assets/images/team_2.jpg" className="img-fluid blur-up lazyload" alt="" />
                                        </div>
                                        <h4>Hileri Keol</h4>
                                        <h6>CEo &amp; Founder At Company</h6>
                                    </div>
                                    <div>
                                        <div>
                                            <img src="assets/images/team_3.jpg" className="img-fluid blur-up lazyload" alt="" />
                                        </div>
                                        <h4>Hileri Keol</h4>
                                        <h6>CEo &amp; Founder At Company</h6>
                                    </div>
                                    <div>
                                        <div>
                                            <img src="assets/images/team_4.jpg" className="img-fluid blur-up lazyload" alt="" />
                                        </div>
                                        <h4>Hileri Keol</h4>
                                        <h6>CEo &amp; Founder At Company</h6>
                                    </div>
